        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Allergies = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Price = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    ExpectedPrepMinutes = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingNr = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderStatuses", x => new { x.OrderId, x.OrderStatusId, x.DateTimeCreated });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderAssignments_UserId_IsCompleted",
                table: "OrderAssignments",
